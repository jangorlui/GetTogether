...
//        UIAlertView *alterView = [[UIAlertView alloc] initWithTitle:@"NetWork Warn" message:@"The network status have problem,please check it!" delegate:nil cancelButtonTitle:@"Ok" otherButtonTitles:nil, nil];
//        [alterView show];
//        [alterView release];
//        return;
//    }else{
